"use strict";(self.webpackChunkbackend=self.webpackChunkbackend||[]).push([[5905],{3500:(oe,O,n)=>{n.r(O),n.d(O,{default:()=>rt});var e=n(27279),C=n(27875),m=n(10701),B=n(48102),H=n(74758),g=n(93415),l=n(17741),M=n(36938),w=n(59082),D=n(26784),X=n(76827),V=n(98934),r=n.n(V),f=n(10131),T=n.n(f),b=n(6078),x=n.n(b),j=n(51943),z=n.n(j),P=n(61020),J=n(51447),G=n(70774),ge=n(38101),fe=n(93153),_=n(50086),Z=n(32370),ke=n(38566),Be=n(70627),o=n.n(Be),K=n(27523),he=n(47558),v=n(90635),$=n(72450);const ye=$.default.tr`
  &.component-row,
  &.dynamiczone-row {
    position: relative;
...
`,M=(0,C.default)(m.x)`
  ...
  width: 100%;
  border: none;
`,w=({children:D,icon:X,...V})=>(0,e.jsxs)("div",{children:[(0,e.jsx)(B.i,{}),(0,e.jsx)(M,{as:"button",background:"primary100",padding:5,...V,children:(0,e.jsxs)(H.k,{children:[(0,e.jsx)(l,{"aria-hidden":!0,background:"primary200",children:X}),(0,e.jsx)(m.x,{paddingLeft:3,children:(0,e.jsx)(g.Z,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:D})})]})})]})}}]);
